...
public class Order {
  ...
  public static Order createLimitOrder(String id, String userId, OrderSide side, Long price,
    ...
    return Order.builder().orderId(id).userId(userId).side(side).type(OrderType.LIMIT).price(price)
            .remainingQuantity(quantity).timestamp(System.currentTimeMillis()).build();
  }
  ...
  public static Order createMarketOrder(String id, String userId, OrderSide side, Long quantity) {
    ...
    return Order.builder().orderId(id).userId(userId).side(side).type(OrderType.MARKET).price(null)
            .remainingQuantity(quantity).timestamp(System.currentTimeMillis()).build();
  }
  ...
  public static Order createIOCOrder(String id, String userId, OrderSide side, Long price,
    ...
    return Order.builder().orderId(id).userId(userId).side(side).type(OrderType.IOC).price(price)
            .remainingQuantity(quantity).timestamp(System.currentTimeMillis()).build();
  }
  ...
  public static Order createFOKOrder(String id, String userId, OrderSide side, Long price,
    ...
    return Order.builder().orderId(id).userId(userId).side(side).type(OrderType.FOK).price(price)
            .remainingQuantity(quantity).timestamp(System.currentTimeMillis()).build();
  }
