...
public class Order {
  ...
  @Builder.Default private Long remainingQuantity = 0L;
  @Builder.Default @Setter private OrderState state = OrderState.NEW;

  public static Order createLimitOrder(
      String id, String userId, OrderSide side, Long price, Long quantity) {
