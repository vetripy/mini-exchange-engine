...
public class OrderStub {
    ...
    public static Order getValidMarketBuyOrderWith(Long quantity) {
        return Order.createMarketOrder(UUID.randomUUID().toString(), "user1", OrderSide.BUY,
            quantity);
    }

    public static Order getValidMarketSellOrderWith(Long quantity) {
        return Order.createMarketOrder(UUID.randomUUID().toString(), "user2", OrderSide.SELL,
            quantity);
    }
